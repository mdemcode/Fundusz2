    ...
    public static class UczestnicyDAL {
        public static ObservableCollection<Uczestnik> Wczytaj() {
            ...
            //if (Properties.Settings.Default._proj) {
                uczestnicy.Add(new Uczestnik { ImieNazwisko = "MichalD", EmailTelefon = "607798", DataPrzystapienia = DateTime.Today });
                uczestnicy.Add(new Uczestnik { ImieNazwisko = "Stasiek", EmailTelefon = "999", DataPrzystapienia = DateTime.Today });
